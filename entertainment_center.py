...
airforceone = media.Movie("Air Force One",
                       "American and Russian Special Forces capture General Ivan Radek (Jürgen Prochnow)",
                       "https://upload.wikimedia.org/wikipedia/en/2/2a/Air_Force_One_(movie_poster).jpg",
                       "https://www.youtube.com/watch?v=vIHPP7c6GNU")

robot = media.Movie("Robots ",
                       "In Rivet Town, Rodney Copperbottom is a young inventor who dreams of making the world a better place)",
                       "http://www.impawards.com/2005/posters/robots.jpg",
